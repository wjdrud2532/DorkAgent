...
def task(target_domain, agents):
    ...
    task1 = Task(
        ...
        site:{target_domain} (intitle:"index of /" | intitle:"docker-compose.yml" | intitle:".env" | intitle:"config.yml" | intitle:".git" | intitle:"package.json" | intitle:"requirements.txt" | intitle:".gitignore" | intitle:"IIS Windows Server")
    ...
    task2 = Task(
        ...
        When analyzing, consider:
         - If the following keywords are included in the URL or title, exclude them from the results.
         - Keywords: “Advertisement”, "Agreement", "Terms and conditions", “Terms of Use”, “API Docs”, “Forum”, “Help”, “Community”, “Code of Conduct”, “Developers”, “Statement”, “Support”, “Rules”, “example”, “Guideline,” and “Template”
        """,
        expected_output=f"""Identified attack surfaces or security vulnerabilities including url links: """,
        agent=agents["bughunter"],
    )

    task3 = Task(
        description=f"""
        If any findings (attack surfaces or security vulnerabilities) were identified in the previous task, compile them into a structured report with link of documents or files.
